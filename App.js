...
const Header=()=>{
    return(
        <div className="header">
            <div>
                <img className="logo" src="https://static.vecteezy.com/system/resources/previews/004/312/696/original/food-logo-template-design-icon-illustration-vector.jpg" alt="Logo"/>
            </div>
            <div className="list">
            <ul >
                <li>Home</li>
...
const RestaurantCard=(props)=>{
    ...
    return(
        <div className="card">
             <img className="card_img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+ cloudinaryImageId }alt=""/>
...
const resList=[
    {
      "info": {
        ...
        "promoted": true,
        "adTrackingId": "cid=16006568~p=0~adgrpid=16006568#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=676814~eid=67d47682-e5e8-44dc-945e-8da95727f4e6~srvts=1724521479663~collid=45995",
        "sla": {
          "deliveryTime": 22,
          "lastMileTravel": 3.9,
      ...
      "cta": {
        "link": "swiggy://menu?restaurant_id=676814",
    ...
    },
    {
      ...
      "cta": {
        "link": "swiggy://menu?restaurant_id=311806",
        "text": "RESTAURANT_MENU",
        "type": "DEEPLINK"
      }
    },
    ...
    },
    {
      ...
      "cta": {
        "link": "swiggy://menu?restaurant_id=74373",
        "text": "RESTAURANT_MENU",
        "type": "DEEPLINK"
      }
    }]
    ...
    return (
        <div className="body">
            <div className="top">
                ...
                <button className="btn">Top rated restaurants</button>
